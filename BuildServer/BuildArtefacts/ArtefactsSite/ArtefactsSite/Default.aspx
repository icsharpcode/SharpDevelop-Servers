...
<asp:Content ID="Content2" ContentPlaceHolderID="PageContent" runat="server">
    ...
    <div>
        <h1>SharpDevelop Reports</h1>
        <asp:ObjectDataSource ID="srArtefactsSource" runat="server" SelectMethod="GetFileListing"
            TypeName="DownloadInformationComponent" SortParameterName="sortExpression">
            <SelectParameters>
                <asp:Parameter DefaultValue="SharpDevelopReports*" Name="artefactQuery" Type="String" />
            </SelectParameters>
        </asp:ObjectDataSource>
    </div>
    
    <asp:GridView ID="srArtefactsGrid" runat="server" AutoGenerateColumns="False" CellPadding="4"
        DataSourceID="srArtefactsSource" ForeColor="#333333" GridLines="None" AllowSorting="True">
        <FooterStyle BackColor="#5D7B9D" Font-Bold="True" ForeColor="White" />
        <Columns>
            <asp:BoundField DataField="FileName" HeaderText="File name" SortExpression="FileName" />
            <asp:BoundField DataField="CreationDate" HeaderText="Build time" SortExpression="CreationDate" />
    ...
    <div>
        <h1>SharpDevelop "Mirador" 4.0 Alpha Builds</h1>
